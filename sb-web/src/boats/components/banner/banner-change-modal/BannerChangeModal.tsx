...
import { ColorBox } from 'boats/components/banner/banner-change-modal/color-box/ColorBox';
import { ImageSearch } from 'boats/components/banner/banner-change-modal/image-search/ImageSearch';
