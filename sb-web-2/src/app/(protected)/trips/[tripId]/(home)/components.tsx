          ...
          >
            ...
            <div className="flex flex-wrap gap-1 pt-1">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                to={`https://www.google.com/maps/dir/?api=1&destination=${trip.location.geo ? `${trip.location.geo.lat}%2C${trip.location.geo.lng}` : trip.location.primaryText}&destination_place_id=${trip.location.placeId}`}
                className={buttonVariants({
                  size: "sm",
                  variant: "outline",
                  className:
