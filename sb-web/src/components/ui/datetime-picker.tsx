...
function genYears(yearRange = 25) {
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex space-y-0 justify-center",
        ...
        button_previous: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-5 top-7",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-5 top-7",
        ),
        ...
        today: "bg-muted text-accent-foreground rounded-md",
        outside:
        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger className="w-[105px] border-none px-1 py-0 focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {MONTHS.map((month) => (
              ...
              >
                <SelectTrigger className="w-fit border-none px-1 py-0 focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {YEARS.map((year) => (
