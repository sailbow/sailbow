              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <Link
                    ...
                    to={`https://www.google.com/maps/dir/?api=1&destination=${item.location.primaryText}&destination_place_id=${item.location.placeId}`}
