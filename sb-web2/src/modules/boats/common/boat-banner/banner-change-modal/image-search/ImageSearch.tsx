...
import { Box, Image, Flex, Spinner, Text } from '@chakra-ui/react';
import Gallery, { RenderImageProps } from 'react-photo-gallery';

import { useBoat } from 'modules/boats/Boat.Store';
import { BannerType, Photo } from 'modules/boats/Boat.Types';
import { SbCheckIcon, SbSearchIcon } from 'shared/icons/Icons';
...
export const ImageSearch: FunctionComponent<Props> = ({ onChange }) => {
    ...
    return (
        <Box className="sb-image-search">
            <Input leftIcon={<SbSearchIcon />} placeholder="Search images..." onChange={onSearch} />
