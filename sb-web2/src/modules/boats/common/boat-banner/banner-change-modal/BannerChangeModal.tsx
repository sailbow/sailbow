...
import { ColorBox } from 'modules/boats/common/boat-banner/banner-change-modal/color-box/ColorBox';
import { ImageSearch } from 'modules/boats/common/boat-banner/banner-change-modal/image-search/ImageSearch';
